( function( $ ) {
						...
						if (layout !== 'full-width' && layout !== '') {
							...
							if (newval <= 3 || newval >= 80) {
								...
								if (layout === 'sidebar-left') {
									...
									$( 'body:not(.page) .blog-sidebar-wrapper' ).removeClass( 'col-md-offset-1' );
								}
							} else {
								if (layout === 'sidebar-left') {
									$( '.blog-posts-wrap, .archive-post-wrap' ).addClass( 'col-md-offset-1' );
								} else {
									$( 'body:not(.page) .blog-sidebar-wrapper' ).addClass( 'col-md-offset-1' );
								}
							}
							content_width = hestia_content_width - 8.33333333;
	...
	wp.customize( 'accent_color', function( value ) {
      ...
      var gradientColor1 = convertHex(newval, 88);
      var gradientColor2 = convertHex(newval, 31);

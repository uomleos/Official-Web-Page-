...
$config = array(
	...
	'menu_name'           => __( 'About Hestia', 'hestia-pro' ),
	// Page title.
	'page_name'           => __( 'About Hestia', 'hestia-pro' ),
	// Main welcome title
	/* translators: s - theme name */
	'welcome_title'       => sprintf( __( 'Welcome to %s! - Version ', 'hestia-pro' ), 'Hestia' ),
...
$config_customizer = array(
	'recommended_plugins'       => array(
		'themeisle-companion' => array(
			...
			'description' => sprintf( esc_html__( 'If you want to take full advantage of the options this theme has to offer, please install and activate %s.', 'hestia-pro' ), sprintf( '<strong>%s</strong>', 'ThemeIsle Companion' ) ),
		),
	),
	'recommended_actions'       => array(),

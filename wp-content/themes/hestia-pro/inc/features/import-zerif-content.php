...
function hestia_import_simple_theme_mods( $content ) {
	...
	if ( empty( $contact_theme_mod ) ) {
		...
		if ( ! empty( $email ) ) {
			$contact_content .= '<div class="hestia-info info-horizontal"><div class="icon icon-primary"><i class="fa fa-envelope"></i></div><div class="description"><h4 class="info-title">' . wp_kses_post( $email ) . '</h4></div>';
		}

		if ( ! empty( $phone ) ) {
			$contact_content .= '<div class="hestia-info info-horizontal"><div class="icon icon-primary"><i class="fa fa-phone"></i></div><div class="description"><h4 class="info-title">' . wp_kses_post( $phone ) . '</h4></div>';
		}

		if ( ! empty( $address ) ) {
			$contact_content .= '<div class="hestia-info info-horizontal"><div class="icon icon-primary"><i class="fa fa-map-marker"></i></div><div class="description"><h4 class="info-title">' . wp_kses_post( $address ) . '</h4></div>';
		}
	...
	if ( empty( $about_content_theme_mod ) ) {
		...
		if ( ! empty( $about_title ) || ! empty( $about_subtitle ) ) {
			...
			if ( ! empty( $about_title ) ) {
				$output .= '<h2 class="hestia-title">' . wp_kses_post( $about_title ) . '</h2>';
			}

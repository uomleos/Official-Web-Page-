...
function hestia_woocommerce_header_add_to_cart_fragment( $fragments ) {
	...
	<a class="cart-contents btn btn-white pull-right" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'hestia-pro' ); ?>">
		<i class="fa fa-shopping-cart"></i>
		<?php
		echo
		/* translators: %d is number of items */
		sprintf( _n( '%d item', '%d items', absint( $woocommerce->cart->cart_contents_count ), 'hestia-pro' ), absint( $woocommerce->cart->cart_contents_count ) );
		?>
		 - 
		<?php
		echo wp_kses(
	...
	<div id="primary" class="<?php echo hestia_boxed_layout_header(); ?> page-header header-filter header-small" data-parallax="active" style="background-image: url('<?php echo hestia_featured_header(); ?>');">
		<div class="container">
			<div class="row text-center">
				...
				<div class="cart-contents-content"><a class="cart-contents btn btn-white pull-right" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'hestia-pro' ); ?>"><i class="fa fa-shopping-cart"></i></a></div>
			</div>
		</div>
	</div>
	</header>

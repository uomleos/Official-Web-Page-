...
class __TwigTemplate_55ceec5fc0c809f6182cd75a13659184886f0e018c0784cbc7820ec1b22a0222 extends Twig_Template
{
        ...
        echo "        >
          <label>
            <input
              ...
              ";
        // line 31
        if ($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "signup_confirmation", array()), "enabled", array())) {
            // line 32
  ...
  <tbody>
      ...
      <td>
        <p>
          <input
            ...
            value=\"";
        // line 68
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "signup_confirmation", array()), "from", array()), "name", array()), "html", null, true);
        echo "\"
            placeholder=\"";
        // line 69
        ...
        echo "\"
          ...
          <input type=\"email\"
            ...
            value=\"";
        // line 74
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "signup_confirmation", array()), "from", array()), "address", array()), "html", null, true);
        echo "\"
      ...
      <td>
        <p>
          <input
            ...
            value=\"";
        // line 94
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "signup_confirmation", array()), "reply_to", array()), "name", array()), "html", null, true);
        echo "\"
            placeholder=\"";
        // line 95
        echo $this->env->getExtension('MailPoet\Twig\I18n')->translate("Your name");
        echo "\"
          ...
          <input type=\"email\"
            ...
            value=\"";
        // line 100
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "signup_confirmation", array()), "reply_to", array()), "address", array()), "html", null, true);
        echo "\"
            placeholder=\"confirmation@mydomain.com\"
            size=\"28\"
            />
    ...
    <tr>
      ...
      <td>
        <input
          ...
          ";
        // line 120
        if ($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "signup_confirmation", array()), "subject", array())) {
            // line 121
            echo "            value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "signup_confirmation", array()), "subject", array()), "html", null, true);
            echo "\"
          ";
        }
        // line 123
    ...
    <tr>
      ...
      <td>
        ...
        >";
        // line 142
        if ($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "signup_confirmation", array()), "body", array())) {
            // line 143
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "signup_confirmation", array()), "body", array()), "html", null, true);
        }
        // line 144
        echo "</textarea>
      </td>
      ...
      <td>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
            ...
            echo "\"
                ";
            // line 167
            if (($this->getAttribute($context["page"], "id", array()) == $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "subscription", array()), "pages", array()), "confirmation", array()))) {
                // line 168
...
";
    ...
    {
        return new Twig_Source("", "settings/signup.html", "/home/uomleoso/public_html/wp-content/plugins/mailpoet/views/settings/signup.html");
    }
}
